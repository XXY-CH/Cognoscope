...
export function buildEvidenceMessages(input: {
  ...
  const system = [
    ...
    '格式：[{"conclusion":"...","evidence":[{"fileId":"...","evidenceType":"support|refute|condition|limitation|method|data|unknown","condition":null,"method":null,"dataset":null,"quotedText":"...","note":"...","annotationId":null,"locator":{"kind":"pdf-page","page":1,"anchor":null}}]}]',
    'locator 只能是 pdf-page、epub-cfi 或 unresolved 三种对象；无法定位时必须使用 unresolved 并说明原因。',
    'quotedText 必须逐字来自对应论文的批注原文或本地文字稿；没有支持时不要编造证据。',
    'evidenceType 只能描述原文中的支持、反驳、条件、局限、方法或数据；无法判断时使用 unknown，不要根据相似性猜测。',
