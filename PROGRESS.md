...
| **Phase 003** | **知识图谱分级与 UI 设计**（研究空间 / 文献 / 概念 / 证据 / 综合判断） | 🛠 首轮实现进行中（筛选、关系来源、节点检查器、KG-05 证据锚点回读已落地） |
...
11. Codex 内置浏览器已用于本轮 UI 验收；真实 IndexedDB 升级与 PDF/EPUB 复杂内容仍需在带实际文档数据的环境继续人工验收。
